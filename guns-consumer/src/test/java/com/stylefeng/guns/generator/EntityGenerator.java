...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("E:\\14th_workspace\\cskaoyan14th-project_4\\guns-consumer\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"mtime_user_t"});//String数组，可以生成多个表
        ...
        pc.setServiceImpl("com.stylefeng.guns.rest.modular.user.service.impl");   //本项目没用，生成之后删掉
