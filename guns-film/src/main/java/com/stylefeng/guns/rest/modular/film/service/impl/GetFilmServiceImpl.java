...
public class GetFilmServiceImpl implements GetFilmService{
    ...
    @Override
    public FilmDateVO selectGetFilmDataListByIdId(Integer showType, Integer sortId, Integer catId, Integer sourceId, Integer yearId, Integer pageSize, Integer nowPage) {
        PageHelper.startPage(nowPage, pageSize);
        List<GetFilmVO> getFilmVO = getFilmMapper.selectGetFilmDataListByIdId(showType, sortId, catId, sourceId, yearId);
